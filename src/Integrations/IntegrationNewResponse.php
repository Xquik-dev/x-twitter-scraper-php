...
use XTwitterScraper\Integrations\IntegrationNewResponse\EventType;
 ...
 * }
 */
final class IntegrationNewResponse implements BaseModel
{
    /** @use SdkModel<IntegrationNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new IntegrationNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * IntegrationNewResponse::with(
     *   id: ...,
     *   config: ...,
     *   createdAt: ...,
     *   eventTypes: ...,
