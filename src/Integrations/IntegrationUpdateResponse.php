...
use XTwitterScraper\Integrations\IntegrationUpdateResponse\EventType;
use XTwitterScraper\Integrations\IntegrationUpdateResponse\Type;

/**
 * @phpstan-type IntegrationUpdateResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class IntegrationUpdateResponse implements BaseModel
{
    /** @use SdkModel<IntegrationUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new IntegrationUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * IntegrationUpdateResponse::with(
     *   id: ...,
     *   config: ...,
     *   createdAt: ...,
     *   eventTypes: ...,
