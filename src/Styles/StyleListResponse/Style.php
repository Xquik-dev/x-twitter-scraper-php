...
namespace XTwitterScraper\Styles\StyleListResponse;
 ...
 * }
 */
final class Style implements BaseModel
{
    /** @use SdkModel<StyleShape> */
    use SdkModel;
    ...
    /**
     * `new Style()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Style::with(fetchedAt: ..., isOwnAccount: ..., tweetCount: ..., xUsername: ...)
     * ```
     *
