...
use XTwitterScraper\Styles\StyleUpdateResponse\Tweet;

/**
 * @phpstan-import-type TweetShape from \XTwitterScraper\Styles\StyleUpdateResponse\Tweet
 *
 * @phpstan-type StyleUpdateResponseShape = array{
 ...
 * }
 */
final class StyleUpdateResponse implements BaseModel
{
    /** @use SdkModel<StyleUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new StyleUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * StyleUpdateResponse::with(
     *   fetchedAt: ...,
     *   isOwnAccount: ...,
     *   tweetCount: ...,
     *   tweets: ...,
