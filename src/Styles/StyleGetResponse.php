...
use XTwitterScraper\Styles\StyleGetResponse\Tweet;

/**
 * @phpstan-import-type TweetShape from \XTwitterScraper\Styles\StyleGetResponse\Tweet
 *
 * @phpstan-type StyleGetResponseShape = array{
 ...
 * }
 */
final class StyleGetResponse implements BaseModel
{
    /** @use SdkModel<StyleGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new StyleGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * StyleGetResponse::with(
     *   fetchedAt: ...,
     *   isOwnAccount: ...,
     *   tweetCount: ...,
     *   tweets: ...,
