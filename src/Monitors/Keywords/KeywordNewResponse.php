 ...
 *
 * @phpstan-type KeywordNewResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class KeywordNewResponse implements BaseModel
{
    /** @use SdkModel<KeywordNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new KeywordNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * KeywordNewResponse::with(
     *   id: ...,
     *   createdAt: ...,
     *   eventTypes: ...,
     *   isActive: ...,
