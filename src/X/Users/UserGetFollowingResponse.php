...
use XTwitterScraper\X\Users\UserGetFollowingResponse\UserListCoverageResponse;
 ...
 * @phpstan-import-type UserListCoverageResponseShape from \XTwitterScraper\X\Users\UserGetFollowingResponse\UserListCoverageResponse
 *
 * @phpstan-type UserGetFollowingResponseVariants = PaginatedUsers|UserListCoverageResponse
 * @phpstan-type UserGetFollowingResponseShape = UserGetFollowingResponseVariants|PaginatedUsersShape|UserListCoverageResponseShape
 */
final class UserGetFollowingResponse implements ConverterSource
{
    use SdkUnion;
