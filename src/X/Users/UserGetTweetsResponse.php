 ...
 * }
 */
final class UserGetTweetsResponse implements BaseModel
{
    /** @use SdkModel<UserGetTweetsResponseShape> */
    use SdkModel;
    ...
    /**
     * `new UserGetTweetsResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UserGetTweetsResponse::with(hasNextPage: ..., nextCursor: ..., tweets: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UserGetTweetsResponse)
     *   ->withHasNextPage(...)
     *   ->withNextCursor(...)
     *   ->withTweets(...)
     * ```
