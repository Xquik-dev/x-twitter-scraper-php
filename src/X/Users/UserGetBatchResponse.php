...
use XTwitterScraper\X\Users\UserGetBatchResponse\User;

/**
 * Paginated list of user profiles with cursor-based navigation.
 *
 * @phpstan-import-type UserShape from \XTwitterScraper\X\Users\UserGetBatchResponse\User
 *
...
final class UserGetBatchResponse implements BaseModel
{
     ...
     * ```
     * UserGetBatchResponse::with(hasNextPage: ..., nextCursor: ..., users: ...)
     * ```
     *
