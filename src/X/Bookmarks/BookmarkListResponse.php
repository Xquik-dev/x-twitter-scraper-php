 ...
 * }
 */
final class BookmarkListResponse implements BaseModel
{
    /** @use SdkModel<BookmarkListResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BookmarkListResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BookmarkListResponse::with(hasNextPage: ..., nextCursor: ..., tweets: ...)
     * ```
     *
