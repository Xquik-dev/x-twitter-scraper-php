...
use XTwitterScraper\X\Media\MediaUploadResponse\Account;
use XTwitterScraper\X\Media\MediaUploadResponse\Action;
use XTwitterScraper\X\Media\MediaUploadResponse\Billing;
use XTwitterScraper\X\Media\MediaUploadResponse\NextAction;
use XTwitterScraper\X\Media\MediaUploadResponse\Request;
use XTwitterScraper\X\Media\MediaUploadResponse\Result;
use XTwitterScraper\X\Media\MediaUploadResponse\Status;
use XTwitterScraper\X\Media\MediaUploadResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Media\MediaUploadResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Media\MediaUploadResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Media\MediaUploadResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Media\MediaUploadResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Media\MediaUploadResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Media\MediaUploadResponse\Target
 *
