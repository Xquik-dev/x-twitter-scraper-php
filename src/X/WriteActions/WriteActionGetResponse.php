...
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Account;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Action;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Billing;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\NextAction;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Request;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Result;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Status;
use XTwitterScraper\X\WriteActions\WriteActionGetResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\WriteActions\WriteActionGetResponse\Target
 *
