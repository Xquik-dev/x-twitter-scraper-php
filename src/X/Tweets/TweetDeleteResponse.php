...
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Account;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Action;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Billing;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\NextAction;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Request;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Result;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Status;
use XTwitterScraper\X\Tweets\TweetDeleteResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\TweetDeleteResponse\Target
 *
 * @phpstan-type TweetDeleteResponseShape = array{
 *   id: string,
...
final class TweetDeleteResponse implements BaseModel
{
    ...
    /**
     * `new TweetDeleteResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TweetDeleteResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
