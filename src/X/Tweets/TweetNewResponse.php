...
use XTwitterScraper\X\Tweets\TweetNewResponse\Account;
use XTwitterScraper\X\Tweets\TweetNewResponse\Action;
use XTwitterScraper\X\Tweets\TweetNewResponse\Billing;
use XTwitterScraper\X\Tweets\TweetNewResponse\NextAction;
use XTwitterScraper\X\Tweets\TweetNewResponse\Request;
use XTwitterScraper\X\Tweets\TweetNewResponse\Result;
use XTwitterScraper\X\Tweets\TweetNewResponse\Status;
use XTwitterScraper\X\Tweets\TweetNewResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\TweetNewResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\TweetNewResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\TweetNewResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\TweetNewResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\TweetNewResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\TweetNewResponse\Target
 *
