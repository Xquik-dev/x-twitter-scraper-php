...
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Account;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Action;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Billing;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\NextAction;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Request;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Result;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Status;
use XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\Retweet\RetweetDeleteResponse\Target
 *
 * @phpstan-type RetweetDeleteResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class RetweetDeleteResponse implements BaseModel
{
    /** @use SdkModel<RetweetDeleteResponseShape> */
    use SdkModel;
    ...
    /**
     * `new RetweetDeleteResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RetweetDeleteResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
