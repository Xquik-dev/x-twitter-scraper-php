...
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Account;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Action;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Billing;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\NextAction;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Request;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Result;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Status;
use XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\Retweet\RetweetNewResponse\Target
 *
 * @phpstan-type RetweetNewResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class RetweetNewResponse implements BaseModel
{
    /** @use SdkModel<RetweetNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new RetweetNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RetweetNewResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
