...
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Account;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Action;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Billing;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\NextAction;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Request;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Result;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Status;
use XTwitterScraper\X\Tweets\Like\LikeNewResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\Like\LikeNewResponse\Target
 *
 * @phpstan-type LikeNewResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class LikeNewResponse implements BaseModel
{
    /** @use SdkModel<LikeNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new LikeNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LikeNewResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
