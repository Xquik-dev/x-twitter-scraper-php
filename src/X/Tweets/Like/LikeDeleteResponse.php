...
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Account;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Action;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Billing;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\NextAction;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Request;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Result;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Status;
use XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Tweets\Like\LikeDeleteResponse\Target
 *
 * @phpstan-type LikeDeleteResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class LikeDeleteResponse implements BaseModel
{
    /** @use SdkModel<LikeDeleteResponseShape> */
    use SdkModel;
    ...
    /**
     * `new LikeDeleteResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LikeDeleteResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
