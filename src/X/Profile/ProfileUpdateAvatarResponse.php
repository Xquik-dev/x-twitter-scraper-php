...
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Account;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Action;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Billing;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\NextAction;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Request;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Result;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Status;
use XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Profile\ProfileUpdateAvatarResponse\Target
 *
 * @phpstan-type ProfileUpdateAvatarResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class ProfileUpdateAvatarResponse implements BaseModel
{
    /** @use SdkModel<ProfileUpdateAvatarResponseShape> */
    use SdkModel;
    ...
    /**
     * `new ProfileUpdateAvatarResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProfileUpdateAvatarResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
     ...
     *
     * ```
     * (new ProfileUpdateAvatarResponse)
     *   ->withID(...)
     *   ->withAccount(...)
     *   ->withAction(...)
     *   ->withBilling(...)
