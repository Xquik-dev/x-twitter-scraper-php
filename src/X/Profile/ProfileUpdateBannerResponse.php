...
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Account;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Action;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Billing;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\NextAction;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Request;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Result;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Status;
use XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Profile\ProfileUpdateBannerResponse\Target
 *
 * @phpstan-type ProfileUpdateBannerResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class ProfileUpdateBannerResponse implements BaseModel
{
    /** @use SdkModel<ProfileUpdateBannerResponseShape> */
    use SdkModel;
    ...
    /**
     * `new ProfileUpdateBannerResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProfileUpdateBannerResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
     ...
     *
     * ```
     * (new ProfileUpdateBannerResponse)
     *   ->withID(...)
     *   ->withAccount(...)
     *   ->withAction(...)
     *   ->withBilling(...)
