...
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Account;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Action;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Billing;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\NextAction;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Request;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Result;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Status;
use XTwitterScraper\X\Communities\CommunityDeleteResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Communities\CommunityDeleteResponse\Target
 *
 * @phpstan-type CommunityDeleteResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class CommunityDeleteResponse implements BaseModel
{
    /** @use SdkModel<CommunityDeleteResponseShape> */
    use SdkModel;
    ...
    /**
     * `new CommunityDeleteResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CommunityDeleteResponse::with(
     *   id: ...,
     *   account: ...,
     *   action: ...,
     *   billing: ...,
