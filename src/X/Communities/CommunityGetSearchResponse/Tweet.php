...
namespace XTwitterScraper\X\Communities\CommunityGetSearchResponse;

use XTwitterScraper\Core\Attributes\Optional;
use XTwitterScraper\Core\Attributes\Required;
use XTwitterScraper\Core\Concerns\SdkModel;
use XTwitterScraper\Core\Contracts\BaseModel;
use XTwitterScraper\X\Communities\CommunityGetSearchResponse\Tweet\Author;

/**
 * Tweet returned from search results with inline author info.
 *
 * @phpstan-import-type AuthorShape from \XTwitterScraper\X\Communities\CommunityGetSearchResponse\Tweet\Author
 *
