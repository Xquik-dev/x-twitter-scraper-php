...
use XTwitterScraper\X\Dm\DmSendResponse\Account;
use XTwitterScraper\X\Dm\DmSendResponse\Action;
use XTwitterScraper\X\Dm\DmSendResponse\Billing;
use XTwitterScraper\X\Dm\DmSendResponse\NextAction;
use XTwitterScraper\X\Dm\DmSendResponse\Request;
use XTwitterScraper\X\Dm\DmSendResponse\Result;
use XTwitterScraper\X\Dm\DmSendResponse\Status;
use XTwitterScraper\X\Dm\DmSendResponse\Target;
 ...
 *
 * @phpstan-import-type AccountShape from \XTwitterScraper\X\Dm\DmSendResponse\Account
 * @phpstan-import-type BillingShape from \XTwitterScraper\X\Dm\DmSendResponse\Billing
 * @phpstan-import-type NextActionShape from \XTwitterScraper\X\Dm\DmSendResponse\NextAction
 * @phpstan-import-type RequestShape from \XTwitterScraper\X\Dm\DmSendResponse\Request
 * @phpstan-import-type ResultShape from \XTwitterScraper\X\Dm\DmSendResponse\Result
 * @phpstan-import-type TargetShape from \XTwitterScraper\X\Dm\DmSendResponse\Target
 *
 * @phpstan-type DmSendResponseShape = array{
 *   id: string,
