 ...
 * Send direct message.
 *
 * @see XTwitterScraper\Services\X\DmService::update()
 *
 * @phpstan-type DmUpdateParamsShape = array{
 *   account: string,
 *   text: string,
 ...
 * }
 */
final class DmUpdateParams implements BaseModel
{
    /** @use SdkModel<DmUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new DmUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DmUpdateParams::with(account: ..., text: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DmUpdateParams)->withAccount(...)->withText(...)
     * ```
     */
