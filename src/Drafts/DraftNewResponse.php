 ...
 * }
 */
final class DraftNewResponse implements BaseModel
{
    /** @use SdkModel<DraftNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new DraftNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DraftNewResponse::with(id: ..., createdAt: ..., text: ..., updatedAt: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DraftNewResponse)
     *   ->withID(...)
     *   ->withCreatedAt(...)
     *   ->withText(...)
     *   ->withUpdatedAt(...)
